...
async function getInput() {
    ...
    // var input = ['https://byui.brightspace.com/d2l/lms/grades/admin/enter/grade_item_edit.d2l?objectId=1739166&ou=341283'];

    var input = [
        'https://byui.brightspace.com/d2l/lms/grades/admin/enter/grade_item_edit.d2l?objectId=1745428&ou=288274',
        ...
        // 'https://byui.brightspace.com/d2l/lms/grades/admin/enter/grade_item_edit.d2l?objectId=2338603&ou=469776'
    ];

    return input;
}

// this will loop through every link calling main(link)
async function loop(links) {
    let input = links.map(link => { return { link, length: links.length }; });
    var output = await pmap(input, main, { concurrency: 1 });
    // console.dir(output, { depth: 5 });
    output = output.filter(semester => {
